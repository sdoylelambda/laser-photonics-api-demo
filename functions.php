...
/**
 * Register a custom "Product" post type.
 * Once this runs, WordPress adds a "Products" menu to WP Admin
 * where you can Add New / Edit / Delete products just like Pages.
 */
